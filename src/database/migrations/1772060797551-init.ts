...
export class Init1772060797551 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            CREATE TABLE "mgm_pacientes" (
                ...
                "segundo_nombre" varchar2(255) NULL,
                ...
                "usuario_modificacion" varchar2(255) NULL,
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`DROP TABLE "mgm_pacientes" CASCADE CONSTRAINTS`);
        await queryRunner.query(`DROP TABLE "daf_tipos_identificacion" CASCADE CONSTRAINTS`);
    }
